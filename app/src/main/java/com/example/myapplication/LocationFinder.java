...
public class LocationFinder extends ActivityCompat {
    ...
    public LocationFinder(String destLongitude, String destLatitude, Context context) { // class for getting phones location
        ...
        setLocationRequest(); // set location requester (from phone) settings, priority...

        setLocationCallback(); // create location requester callback function, (for handling the given location from the phone)
    ...
    public int getDistanceFromUserToDestination() {
        ...
        double lat1 = Double.parseDouble(latitude); // global variables that get updated in the callback
    ...
    public void setLocationCallback() {
        this.locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                for (Location location : locationResult.getLocations()) { // not really important to have a for loop here, can use first value
